# Product Matcher Marketing Website

This is the marketing website for Product Matcher, hosted on GitHub Pages.
...
5. Click Save
6. Your site will be available at: `https://yourusername.github.io/product-matcher/`
...
- `https://productmatcher.lemonsqueezy.com/checkout` → Your actual LemonSqueezy checkout URL
- `support@productmatcher.com` → Your actual support email
- `business@productmatcher.com` → Your actual business email

### Add Images

Create the following images and place them in the `images/` folder:

1. **favicon.png** (32x32 or 64x64) - Browser tab icon
2. **og-image.png** (1200x630) - Social media preview image
...
All website code is part of the Product Matcher project.

## Contact

For website issues or suggestions, please open an issue on GitHub or contact support@productmatcher.com.
